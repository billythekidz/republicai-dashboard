...
def main():
    ...
    print()
    print("=" * 70)
    print("🔗 SHARE THIS — Others can add your peers to their config:")
    print("=" * 70)
    print()
    print("# Copy-paste this command into another validator's terminal:")
    print()
    print(f'PEERS="{peers_csv}"')
    print('sed -i.bak "s/^persistent_peers *=.*/persistent_peers = \\"$PEERS\\"/" $HOME/.republicd/config/config.toml')
    print('systemctl restart republicd')
    print()
    print("=" * 70)
    print()
    print("# Or just the peer list (for manual editing):")
    print()
    print(peers_csv)
